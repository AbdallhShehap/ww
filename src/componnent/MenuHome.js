      ...
      <MDBContainer fluid>
        ...
        <MDBCollapse navbar show={showNavSecond} >
          ...
          >
            <MDBNavbarLink
              href='#'
              style={{ color: "white", fontSize: "20px", margin: "0 1rem" }}
            >
              HOME
            </MDBNavbarLink>
            <MDBNavbarLink
            ...
            <MDBNavbarLink
              href='#'
              style={{ color: "white", fontSize: "25px", margin: "0 1rem" }}
            >
              OUR_PRODUCTS
            </MDBNavbarLink>
            <MDBNavbarLink
          ...
          >
            <MDBIcon icon='search' fas style={{ color: "white", marginRight:"3rem" , fontSize:"30px" }} />
            <MDBIcon
              icon='facebook'
              fab
